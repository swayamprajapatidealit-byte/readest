...
const FoliateViewer: React.FC<{
  ...
  useEffect(() => {
    ...
    const openBook = async () => {
      ...
      // position. Mark the view as a preview so the progress auto-save skips
      // until the user takes a reading action. The flag clears on the first
      // user-initiated relocate (page / scroll) in docRelocateHandler below.
      if (overrideLocation) {
