 ...
 * flat snapshot cannot mesh-bend). Desktop and web builds retain the browser
 * View Transition implementation when it is available.
 */
export const getCapturedTurnStyle = (
  ...
  if (viewSettings.pageTurnStyle === 'slide' && !detectViewTransitionGroup()) {
    return 'slide';
  }
  return null;
};
