...
// Proofread rewrites the rendered text through the content transformers,
// which every reflowable book runs. Fixed-layout (pre-paginated) books are
// out: they render pages, not text.
export const supportsProofread = (isFixedLayout: boolean | undefined): boolean => !isFixedLayout;
